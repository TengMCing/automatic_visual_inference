# train a single poly plot model for heter --------------------------------
...
train_gen <- data_gen$flow_from_directory(directory = here::here("data/single_plot/heter_train"),
...
val_gen <- data_gen$flow_from_directory(directory = here::here("data/single_plot/heter_train"),
                                        target_size = c(224L, 224L),
                                        batch_size = 32L,
                                        shuffle = TRUE,
                                        seed = 10086L,
...
this_callbacks = list(callback_early_stopping(patience = 5L), 
                      callback_tensorboard("logs/single_plot_heter"))
...
saveRDS(fit_history, here::here("history/single_plot_heter.rds"))
this_model$save(here::here("models/single_plot_heter"))
