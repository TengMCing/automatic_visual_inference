...
train_gen <- data_gen$flow_from_directory(directory = here::here("data/single_plot/poly_train"),
...
val_gen <- data_gen$flow_from_directory(directory = here::here("data/single_plot/poly_train"),
                                        target_size = c(224L, 224L),
                                        batch_size = 32L,
                                        shuffle = TRUE,
                                        seed = 10086L,
